...
class UserRegistrationForm(UserCreationForm):    
    ...
    # amader ager save method notun kore likhte hobe, karon amra ekoisathe 3 ta model save korte chacchi. ejonno amader kichu customize korte hobe.   
